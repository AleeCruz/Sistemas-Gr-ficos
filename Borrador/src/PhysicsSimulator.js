...
export const defaultVehicleParams = {
    // PARÁMETROS AJUSTADOS PARA UN COCHE MUCHO MÁS PEQUEÑO
    wheelSeparation: 0.9, // Original: 2.5 -> 1.8. Ahora mucho más estrecho.
    axesSeparation: 1.1, // Original: 3 -> 2.2. Ahora mucho más corto.
    wheelRadius: 0.2,    // Original: 0.6 -> 0.4. Radio de las ruedas mucho más pequeño.
    wheelWidth: 0.12,    // Original: 0.4 -> 0.25. Ancho de las ruedas mucho más pequeño.
    suspensionRestLength: 0.25, // Original: 0.8 -> 0.5. Suspensión más corta.
    initialPosition: new THREE.Vector3(0, 0.5, 0), // Original: (0,2,0) -> (0,1,0). Posición inicial muy baja.
    initialYRotation: 0,
    steeringReaction: 0.1,
    maxSteeringAngle: Math.PI / 8, // Podría girar más bruscamente al ser más pequeño
    mass: 1, // Original: 10 -> 5. MUY REDUCIDO: Crucial para el comportamiento físico de un coche diminuto.
    accelerateForce: {
        min: -5, // Menos fuerza de retroceso máxima
        max: 15,  // Menos fuerza de aceleración máxima (pero más ágil para su masa)
        step: 0.75, // Pasos más pequeños para control más fino
    },
    brakeForce: {
        min: 0,
        max: 0.5, // Fuerza de frenado máxima
        step: 0.05,
    },
}
...
export class PhysicsSimulator {
    ...
    async initSimulation() {
        ...
        // create chassis
        // MUY AJUSTADO: Ancho, Alto, Profundidad del chasis FÍSICO
        geo = new THREE.BoxGeometry(0.8, 0.35, 1.5); // Coincide con las dimensiones visuales en main.js
